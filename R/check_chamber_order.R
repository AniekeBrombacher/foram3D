...
#' angles between consecutive chambers. In species with four or more chambers in the final whorl 
#' the angles between consecutive chambers are expected to be larger than 90 degrees. The 
#' exception is the angle between the first three chambers, which is closer to 60 degrees. In 
